...
Siftable Skills is a collection of reusable operating procedures for coding and knowledge agents. Each skill captures a workflow that has been exercised in real work: reclaiming disk space without racing active processes, making forecasts that can be scored later, editing prose without changing its claims, using the TypeScript compiler as an engineering tool, and retrieving evidence from a private local corpus.
...
- **v0.1.0:** the five skills in this repository
- **v0.2.0:** a portable Zig engineering skill
- **v0.3.0:** a sanitized pgvector/Postgres skill grounded in redistributable primary sources
